...
class ResumeApp:
    ...
    def apply_global_styles(self):
        ...
        .feature-card {
            ...
            border-radius: 10px;
            color: #a0d8ef;        /* soft light blue text */
            padding: 20px;
            margin-bottom: 20px;
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <p style='text-align: center;'>
                Powered by <b>Streamlit</b> and <b>Google Gemini AI</b> | Developed by Jnaneswar
            </p>
            """, unsafe_allow_html=True)
    ...
    def render_analyzer(self):
        ...
        page_header(
            ...
            "Receive immediate AI-powered insights to refine your resume."
        )

        # Create tabs for Normal Analyzer and AI Analyzer
        analyzer_tabs = st.tabs(["Quick Scan", "Deep Dive AI"])
    ...
    def render_home(self):
        ...
        hero_section(
            ...
            "Craft Your Resume — Powered by AI Precision",
            "Leverage AI technology to analyze and build your resume. Get personalized guidance to create a professional resume that impresses."
        )
        ...
        feature_card(
            "fas fa-lightbulb", 
            "AI-Driven Insights",
            "Experience intelligent resume evaluation with AI that reveals your strengths and areas to refine."
        )
        
        feature_card(
            "fas fa-rocket",
            "Intelligent Resume Creator",
            "Build standout resumes effortlessly with AI-driven content suggestions and formatting guidance."
        )
